        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-2xl h-[80vh] flex flex-col">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        FileForge is a secure, client-side file converter. Your files never leave your device.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="flex-1 overflow-y-auto p-2 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {formats.map((group) => (
                                <div key={group.category} className="p-3 border rounded-lg bg-muted/20">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-sm">
                            <div className="flex justify-between p-2 rounded bg-muted">
                                <span>Open File</span>
                                <kbd className="px-1.5 py-0.5 text-xs bg-background border rounded">Ctrl + O</kbd>
                            </div>
                            <div className="flex justify-between p-2 rounded bg-muted">
                                <span>Paste File</span>
                                <kbd className="px-1.5 py-0.5 text-xs bg-background border rounded">Ctrl + V</kbd>
                            </div>
                            <div className="flex justify-between p-2 rounded bg-muted">
                                <span>Settings</span>
                                <kbd className="px-1.5 py-0.5 text-xs bg-background border rounded">Ctrl + ,</kbd>
                            </div>
                            <div className="flex justify-between p-2 rounded bg-muted">
                                <span>Help</span>
