export type FormatCategory = 'image' | 'document' | 'audio' | 'video' | 'spreadsheet' | 'data' | 'archive';
...
export const FORMATS: Record<string, FormatDefinition> = {
    ...
    jpg: {
        ...
        extensions: ['jpg', 'jpeg'],
        safe: true,
        compatibleOutputs: ['png', 'webp', 'gif', 'bmp', 'tiff', 'avif', 'ico', 'pdf'],
    },
    jpeg: {
        label: 'JPEG Image',
        category: 'image',
    ...
    png: {
        ...
        extensions: ['png'],
        safe: true,
        compatibleOutputs: ['jpg', 'webp', 'gif', 'bmp', 'tiff', 'avif', 'ico', 'pdf'],
    },
    webp: {
        label: 'WebP Image',
        category: 'image',
        ...
        extensions: ['webp'],
        safe: true,
        compatibleOutputs: ['jpg', 'png', 'gif', 'bmp', 'tiff', 'avif', 'ico', 'pdf'],
    },
    gif: {
        label: 'GIF Image',
        category: 'image',
        ...
        extensions: ['gif'],
        safe: true,
        compatibleOutputs: ['jpg', 'png', 'webp', 'bmp', 'tiff', 'avif', 'ico', 'pdf', 'mp4'],
    },
    bmp: {
        label: 'Bitmap Image',
        category: 'image',
        ...
        extensions: ['bmp'],
        safe: true,
        compatibleOutputs: ['jpg', 'png', 'webp', 'gif', 'tiff', 'avif', 'ico', 'pdf'],
    },
    tiff: {
        label: 'TIFF Image',
        category: 'image',
        ...
        extensions: ['tiff', 'tif'],
        safe: false,
        compatibleOutputs: ['jpg', 'png', 'webp', 'gif', 'bmp', 'avif', 'ico', 'pdf'],
    },
    heic: {
        label: 'HEIC Image',
        category: 'image',
        ...
        extensions: ['heic'],
        safe: false,
        compatibleOutputs: ['jpg', 'png', 'webp', 'gif', 'bmp', 'tiff', 'avif', 'ico', 'pdf'],
    },
    ico: {
        label: 'Icon',
        category: 'image',
    ...
    avif: {
        ...
        extensions: ['avif'],
        safe: true,
        compatibleOutputs: ['jpg', 'png', 'webp', 'gif', 'bmp', 'tiff', 'ico', 'pdf'],
    },
    ...
    mp4: {
        ...
        extensions: ['mp4'],
        safe: true,
        compatibleOutputs: ['webm', 'avi', 'mkv', 'mov', 'wmv', 'flv', 'gif', 'mp3'],
    },
    webm: {
        label: 'WebM Video',
        category: 'video',
    ...
    avi: {
        ...
        extensions: ['avi'],
        safe: false,
        compatibleOutputs: ['mp4', 'webm', 'mkv', 'mov', 'wmv', 'flv', 'gif', 'mp3'],
    },
    mkv: {
        label: 'MKV Video',
        category: 'video',
        ...
        extensions: ['mkv'],
        safe: false,
        compatibleOutputs: ['mp4', 'webm', 'avi', 'mov', 'wmv', 'flv', 'gif', 'mp3'],
    },
    mov: {
        ...
        extensions: ['mov'],
        safe: true, // Safari
        compatibleOutputs: ['mp4', 'webm', 'avi', 'mkv', 'wmv', 'flv', 'gif', 'mp3'],
    },
    wmv: {
        label: 'WMV Video',
        category: 'video',
        ...
        extensions: ['wmv'],
        safe: false,
        compatibleOutputs: ['mp4', 'webm', 'avi', 'mkv', 'mov', 'flv', 'gif', 'mp3'],
    },
    flv: {
        label: 'Flash Video',
        category: 'video',
        ...
        extensions: ['flv'],
        safe: false,
        compatibleOutputs: ['mp4', 'webm', 'avi', 'mkv', 'mov', 'wmv', 'gif', 'mp3'],
    },
